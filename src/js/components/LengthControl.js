  ...
  return(
    <div id="length-control" className="row">
        <div id="break-control" className="row col text-center">
          ...
          <div id="break-decrement" className="col btn" onClick={() => brDec()}><i className="fa-solid fa-arrow-down"></i></div>
          <div id="break-lenght" className="col">{props.brLength}</div>
          <div id="break-increment" className="col btn" onClick={() => brInc()}><i className="fa-solid fa-arrow-up"></i></div>
        </div>

        <div id="session-control" className="row col text-center">
          <div id="session-label">Session</div>
          <div id="session-decrement" className="col btn" onClick={() => seDec()}><i className="fa-solid fa-arrow-down"></i></div>
          <div id="session-length" className="col">{props.seLength}</div>
          <div id="session-increment" className="col btn" onClick={() => seInc()}><i className="fa-solid fa-arrow-up"></i></div>
        </div>
    </div>
  )
};
